    ...
    <div className={clsx('relative', className)}>
      ...
      <div className="mt-1 relative">
        <input
            ...
            required={required}
            onChange={onChange}
            className={clsx("appearance-none block w-full px-3 py-2 border sm:text-sm",
        ...
        <div
          ...
          className="absolute inset-y-0 right-0 pr-3 flex items-center cursor-pointer text-neutral-300 hover:text-neutral-500" style={{cursor: 'pointer'}}>
                      {!showPassword && <EyeOffIcon className="h-5 w-5" aria-hidden="true" />}
