...
const Aliases = require('../../aliases.model');
const Namespaces = require('../../aliasNamespaces.model');
...
module.exports = {
  up: async query => {
    ...
    await query.createTable('Aliases', Aliases.model);
    await query.createTable('Namespaces', Namespaces.model);
