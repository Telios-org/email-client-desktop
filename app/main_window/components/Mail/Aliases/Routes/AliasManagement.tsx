                        ...
                        {AliasData.filter(f => f.ns === ns).map(
                          (alias, aliasIdx) => (
                            ...
                            >
                              ...
                              <td className="border-b border-gray-200 whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                              ...
                              <td className="border-b border-gray-200 whitespace-nowrap px-3 py-4 text-center w-[70px]">
                                <Switch
                                  ...
                                  className={`${
                                    !alias.disabled ? 'bg-sky-500' : 'bg-red-500'
                                  }
                              ...
                              <td className="border-b border-gray-200 relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium w-[70px]">
                                <div className="flex flex-row justify-end">
                                  ...
                                  >
                                    ...
                                    />
                                    <span className="bg-gray-900 opacity-70 text-white absolute right-5 -top-1 px-2 py-1 text-xs rounded hidden group-focus:block">Copied!</span>
                                  </button>
                                  ...
                                  <Edit
                                    ...
                                    style={{ cursor: 'pointer' }}
                                    onClick={() =>
                                      onShowEdit(`${alias.ns}+${alias.alias}`)}
                                  />
                                  <span className="mx-1" />
                                  <Delete
                                    set="broken"
