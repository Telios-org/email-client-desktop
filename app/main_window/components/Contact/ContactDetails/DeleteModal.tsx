...
const DeleteModal = (props: Props) => {
  const { open, profile, setOpen, onDelete } = props;
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        Are you sure you want to delete <b>{profile?.name}</b> from your contacts? 
                      </p>
                      <p className="text-sm text-gray-500 mt-4">
                        All of your data about this contact will be permanently removed. This action
                        cannot be undone.
                      </p>
                    </div>
                  </div>
