      ...
      <div className="max-w-xs mx-auto h-full flex flex-col">
        <div className="mb-8">
          ...
          <div className="mt-3 text-center sm:mt-5">
            <h3 className="font-bold text-black">Account recovered!</h3>
            <div className="mt-5">
              <p className="text-sm text-gray-500">
                Your account was successfully recovered. You can now return to
                the login page and log back into your account.
              </p>
            </div>
          </div>
        </div>
